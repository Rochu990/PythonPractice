from zadanie_mediana import first_sunday, solution
...
def test_s():
    expenses = {
        ...
        "2023-03": {
            "07": {"food": [20, 11.9, 30.20, 11.9]},
            "04": {"food": [10.20, 11.50, 2.5], "fuel": []},
        },
        "2023-04": {},
    }
...
def test():
    expenses = {
        "2023-05": {
            "01": {"food": [1, 2, 3, 4, 5], "fuel": [6]},
            "02": {"food": [2, 3], "fuel": [5, 7]},
            "03": {
                "food": [2, 3],
            },
            "04": {"food": [2, 3], "fuel": []},
            "05": {"tibia_account_premium": [41], "fuel": [5]},
            "06": {"drugs": [], "fuel": [5, 7], "cos": [5, 7]},
            "07": {"food": [123], "fuel": [5, 7]},
            "08": {"food": [], "fuel": [5, 7]},
        },
    }
